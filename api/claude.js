  ...
  try {
    ...
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 2000, // הקטנו כדי לזרז
        system: "Return ONLY a minified JSON array. Keys: m, q, o, a. Be extremely concise.",
        messages: [
          { role: "user", content: `Create a 3-question quiz about ${topic} for: ${JSON.stringify(members)}` }
        ],
      }),
    });
